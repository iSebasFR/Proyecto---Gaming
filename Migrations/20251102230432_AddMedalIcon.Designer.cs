...
namespace Proyecto_Gaming.Migrations
{
    ...
    [Migration("20251102230432_AddMedalIcon")]
    partial class AddMedalIcon
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proyecto_Gaming.Models.ContactMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Proyecto_Gaming.Models.Surveys.Medal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Proyecto_Gaming.Models.Surveys.Survey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Proyecto_Gaming.Models.Surveys.SurveyAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Proyecto_Gaming.Models.Surveys.SurveyOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Proyecto_Gaming.Models.Surveys.SurveyQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Proyecto_Gaming.Models.Surveys.SurveyResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Proyecto_Gaming.Models.Surveys.UserMedal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Proyecto_Gaming.Models.Surveys.Survey", b =>
                {
                    b.HasOne("Proyecto_Gaming.Models.Surveys.Medal", "Medal")
                        .WithMany("Surveys")
            ...
            modelBuilder.Entity("Proyecto_Gaming.Models.Surveys.SurveyAnswer", b =>
                {
                    b.HasOne("Proyecto_Gaming.Models.Surveys.SurveyOption", "SelectedOption")
                        .WithMany()
                        .HasForeignKey("SelectedOptionId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Proyecto_Gaming.Models.Surveys.SurveyQuestion", "Question")
                        .WithMany("Answers")
                        .HasForeignKey("SurveyQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Proyecto_Gaming.Models.Surveys.SurveyResponse", "Response")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("Proyecto_Gaming.Models.Surveys.SurveyQuestion", b =>
                {
                    b.HasOne("Proyecto_Gaming.Models.Surveys.Survey", "Survey")
                        .WithMany("Questions")
